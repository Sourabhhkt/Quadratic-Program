...
float** sqmat_mul_mat( int _r, int _c, float** _A,float** _B){
  ...
  for (_i = 0; _i < _r; _i++){
      ...
      for (_k = 0; _k < _c; _k++){
        result[_i][_k] = 0;
          for (_j = 0; _j < _r; _j++){
            result[_i][_k] += _A[_i][_j]*_B[_j][_k];
...
float get_step_size(char* inst_name, char* w_name){
  ...
  if (strcmp(inst_name,qplib_0018)==0){
    ...
    if (strcmp(w_name,w0)==0){
      step_size = 0.0010703*0.98;
    }else if (strcmp(w_name,w1)==0){
      step_size = 0.00056736*0.98;
    }else if (strcmp(w_name,w2)==0){
      step_size = 0.000536811*0.98;
    }else if (strcmp(w_name,w3)==0){
      step_size = 0.000422592*0.98;
    }else if (strcmp(w_name,w4)==0){
      step_size = 0.0005768*0.98;
    }else{
      step_size = 1;
    }
  }
